...
//==============================================================================
FREEQAudioProcessor::FREEQAudioProcessor()
...
//==============================================================================
const juce::String FREEQAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool FREEQAudioProcessor::acceptsMidi() const
{
...
bool FREEQAudioProcessor::producesMidi() const
{
...
bool FREEQAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double FREEQAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int FREEQAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int FREEQAudioProcessor::getCurrentProgram()
{
    return 0;
}

void FREEQAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String FREEQAudioProcessor::getProgramName (int index)
{
    return {};
}

void FREEQAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void FREEQAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
void FREEQAudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool FREEQAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void FREEQAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
    ...
    *rightChain.get<ChainPositions::Peak>().coefficients = *peakCoefficients;
    ...
    auto cutCoefficients = juce::dsp::FilterDesign<float>::designIIRHighpassHighOrderButterworthMethod(chainSettings.lowCutFreq, chainSettings.lowCutFreq getSampleRate(), 2 * (chainSettings.lowCutSlope + 1));
    //TODO make cutCoefficients work for both high and low cut filters.
    //low-Cut
...
//==============================================================================
bool FREEQAudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* FREEQAudioProcessor::createEditor()
{
    return new juce::GenericAudioProcessorEditor(*this);
}

//==============================================================================
void FREEQAudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void FREEQAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
ChainSettings getChainSettings(juce::AudioProcessorValueTreeState& apvts)
{
    ...
    settings.lowCutFreq = apvts.getRawParameterValue("LowCut Freqency")->load();
    settings.lowCutSlope = static_cast<Slope>(apvts.getRawParameterValue("LowCut Slope")->load());
    settings.highCutFreq = apvts.getRawParameterValue("HighCut Freqency")->load();
    settings.highCutSlope = static_cast<Slope>(apvts.getRawParameterValue("HighCut Slope")->load());
    settings.peakFreq = apvts.getRawParameterValue("Peak Freqency")->load();
...
juce::AudioProcessorValueTreeState::ParameterLayout
    FREEQAudioProcessor::createParameterLayout()
    {
...
{
    return new FREEQAudioProcessor();
}
